...
<div class="site-container">
    <div class="d-flex align-items-center mb-4">
        ...
        <h3 class="title-section mb-0">Modifier : <?php echo esc($item['description']); ?></h3>
    </div>
    ...
    <div class="card-item p-4">
        <form action="<?php echo base_url('admin/partenaires/'.$item['id']); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid-2 gap-4">
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="description" class="form-input w-100 p-2"
                        value="<?php echo old('description', $item['description']); ?>" required>
                </div>
            ...
            <div class="d-flex align-items-center justify-content-between p-2 border rounded bg-light mb-2 suppr-img">
                <img src="<?php echo base_url('uploads/'.$item['image_path']); ?>" class="img-partenaires">
                <a href="<?php echo base_url('admin/partenaires/'.$item['id'].'/deleteImage'); ?>"
