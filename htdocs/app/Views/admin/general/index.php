            ...
            <div class="grid-2 gap-4">
                <div class="form-group mb-3">
                    ...
                    <input type="number" name="nombreNageurs" class="form-input w-100 p-2"
                        value="<?php echo old('nombreNageurs', $item['nombreNageurs']); ?>">
                </div>
                <div class="form-group mb-3">
