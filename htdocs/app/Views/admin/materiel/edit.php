...
<div class="site-container">
    <div class="d-flex align-items-center mb-4">
        <a href="<?= base_url('admin/materiel') ?>" class="text-decoration-none me-3 text-dark">
    ...
    <div class="card-item p-4">
        <form action="<?= base_url('admin/materiel/' . $item['id']) ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="grid-2 gap-4">
                ...
                <div class="form-group mb-3">
                    ...
                    <select name="idPret" class="form-input w-100 p-2" required>
                        ...
                        <option value="<?= $tp['id'] ?>"
                            <?= (old('idPret', $item['idPret']) == $tp['id']) ? 'selected' : '' ?>>
                            <?= esc($tp['nom']) ?>
                        </option>
                        <?php endforeach; ?>
                        <?php endif; ?>
            ...
            <div class="d-flex align-items-center justify-content-between p-2 border rounded bg-light mb-2 suppr-img">
                <img src="<?= base_url('uploads/' . $item['image_path']) ?>" class="img-materiel">
                <a href="<?= base_url('admin/materiel/' . $item['id'] . '/deleteImage') ?>"
