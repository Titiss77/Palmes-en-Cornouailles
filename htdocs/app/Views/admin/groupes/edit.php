...
<div class="site-container">
    ...
    <div class="card-item p-4">
        <form action="<?php echo base_url('admin/groupes/'.$item['id']); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="d-flex gap-2">
                        <input type="color" class="form-control form-control-color" id="colorPicker"
                            value="<?php echo esc($item['codeCouleur'] ?: '#002d5a'); ?>" style="width: 50px; padding: 5px;">
                        <input type="text" name="codeCouleur" id="codeCouleur" class="form-input w-100 p-2"
                            value="<?php echo old('codeCouleur', $item['codeCouleur']); ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex align-items-center justify-content-between p-2 border rounded bg-light mb-2 suppr-img">
                <img src="<?php echo base_url('uploads/'.$item['image_path']); ?>" class="img-groupes">
                <a href="<?php echo base_url('admin/groupes/'.$item['id'].'/deleteImage'); ?>"
