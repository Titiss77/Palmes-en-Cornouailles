...
<div class="site-container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo base_url('admin/partenaires/new'); ?>" class="btn-home">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            ...
                            <img src="<?php echo base_url('uploads/'.$p['image_path']); ?>"
                        ...
                        <td class="fw-bold"><?php echo esc($p['description']); ?></td>
                        <td>
                            <span class="badge bg-light text-dark border"><?php echo esc($p['ordre']); ?></span>
                        </td>
                        <td class="text-end">
                            <a href="<?php echo base_url('admin/partenaires/'.$p['id'].'/edit'); ?>"
                                class="btn-icon text-primary me-1"><i class="bi bi-pencil-square"></i></a>
                            <a href="<?php echo base_url('admin/partenaires/'.$p['id'].'/delete'); ?>"
