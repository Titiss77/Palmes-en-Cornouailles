...
<div class="site-container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo base_url('admin/calendriers/new'); ?>" class="btn-home">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            ...
                            <?php } else { ?>
                            <img src="<?php echo base_url('uploads/'.$c['image_path']); ?>" class="rounded shadow-sm"
                        ...
                        ?>
                            <span class="badge <?php echo $badgeClass; ?>"><?php echo ucfirst($c['categorie']); ?></span>
                        </td>
                        <td class="fw-bold">
                            <?php echo esc($c['date']); ?>
                        </td>
                        <td class="text-end">
                            <a href="<?php echo base_url('admin/calendriers/'.$c['id'].'/edit'); ?>"
                                class="btn-icon text-primary me-1"><i class="bi bi-pencil-square"></i></a>
                            <a href="<?php echo base_url('admin/calendriers/'.$c['id'].'/delete'); ?>"
