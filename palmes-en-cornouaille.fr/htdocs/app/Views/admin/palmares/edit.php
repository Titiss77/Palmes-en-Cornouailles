...
<div class="site-container">
    ...
    <div class="card-item p-4">
        <form action="<?php echo base_url('admin/palmares/'.$item['id']); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid-2 gap-4">
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="competition" class="form-input w-100 p-2"
                        value="<?php echo old('competition', $item['competition']); ?>" required>
                </div>
                <div class="form-group mb-3">
                    <label class="fw-bold mb-1">Date de la compétition *</label>
                    <input type="date" name="date_epreuve" class="form-input w-100 p-2"
                        value="<?php echo old('date_epreuve', $item['date_epreuve']); ?>" required>
                </div>
            </div>
                ...
                <div class="col-md-4 mb-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="epreuve" class="form-input w-100 p-2"
                            value="<?php echo old('epreuve', $item['epreuve']); ?>" required>
                    </div>
                </div>
                <div class="col-md-4 mb-3">
                    <div class="form-group">
                        ...
                        <input type="number" name="classement" class="form-input w-100 p-2"
                            value="<?php echo old('classement', $item['classement']); ?>" required>
                    </div>
                </div>
                <div class="col-md-4 mb-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="temps" class="form-input w-100 p-2"
                            value="<?php echo old('temps', $item['temps']); ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <div
                    ...
                    <a href="<?php echo base_url('admin/palmares/'.$item['id'].'/deleteImage'); ?>"
